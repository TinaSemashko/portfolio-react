...
export const ButtonSwitchABS = styled(Button)`
  ...
  justify-content: center;
  align-items: center;
  box-shadow: -5px -5px 15px #6a0707, 5px 5px 15px #4b0000,
    inset 5px 5px 10px #531f1f, inset -5px -5px 10px #4b0000;
  cursor: pointer;
  border: none;
  transition: 500ms;
  ...
  &:hover {
    box-shadow: -5px -5px 15px #6a0707, 5px 5px 15px #4b0000,
      inset 5px 5px 10px #4b0000, inset -5px -5px 10px #6a0707;
    background: #f9f9f9;
    background-clip: text;
    transition: 500ms;
  }
